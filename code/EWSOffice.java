...
public class EWSOffice{
   ...
   public  ExchangeService loginEWS(String username) {
       ...
       try {
    	    ...
    	    String user=ewsAccesToken.userName(accessToken);
    	    // handle the username matching here.
    	    System.out.println(user+"user name id extracted through token");
